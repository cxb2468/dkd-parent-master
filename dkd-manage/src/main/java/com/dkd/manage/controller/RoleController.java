...
public class RoleController extends BaseController
{
    ...
    @Log(title = "人员角色", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, Role role)
    {
        List<Role> list = roleService.selectRoleList(role);
        ExcelUtil<Role> util = new ExcelUtil<Role>(Role.class);
        util.exportExcel(response, list, "人员角色数据");
    }
    ...
    @Log(title = "人员角色", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "人员角色", businessType = BusinessType.DELETE)
