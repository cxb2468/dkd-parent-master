...
public class TaskServiceImpl implements ITaskService 
{
    ...
    public int insertTaskDto(TaskDto taskDto) {
        //根据设备innerCode查询设备信息
        VendingMachine vm = vendingMachineService.selectVendingMachineByInnerCode(taskDto.getInnnerCode());
        //判断设备是否存在
        if (vm == null) {
        ...
        //3. 检查设备是否有未完成的同类型工单
        hasTask(taskDto.getInnnerCode(), taskDto.getProductTypeId());
        //4. 查询并校验员工是否存在
